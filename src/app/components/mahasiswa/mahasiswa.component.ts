...
export class MahasiswaComponent implements OnInit { // Mendeklarasikan class komponen dengan implementasi OnInit untuk inisialisasi.
  ...
  apiMahasiswaUrl = 'https://express-application-generator.vercel.app/api/mahasiswa'; // URL API untuk mengambil dan menambahkan data mahasiswa.
  apiProdiUrl = 'https://express-application-generator.vercel.app/api/prodi'; // URL API untuk mengambil data prodi.
