...
export class ProdiComponent implements OnInit { // Mendeklarasikan class komponen dengan implementasi OnInit untuk inisialisasi.
  ...
  apiProdiUrl = 'https://express-application-generator.vercel.app/api/prodi'; // URL API untuk mengambil dan menambahkan data prodi.
  apiFakultasUrl = 'https://express-application-generator.vercel.app/api/fakultas'; // URL API untuk mengambil data fakultas.
